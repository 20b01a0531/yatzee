...
timer = pygame.time.Clock()  #controls the speed of the game
fps = 60
...
running = True   #game starts here
while running:
    timer.tick(fps)
    screen.fill((128, 128, 128))
    button1 = pygame.draw.rect(screen, (0, 0, 0), [10, 160, 280, 30])  #roll button
